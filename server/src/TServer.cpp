...
static Sint16 screenWidth = 800, screenHeight = 600;
TPlayer *localPlayer;
...
void TServer::GaniDraw(const CString &animation, int x, int y, int dir) {
	auto currentTimer = std::chrono::high_resolution_clock::now();
